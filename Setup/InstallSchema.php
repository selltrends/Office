...
class InstallSchema implements InstallSchemaInterface
{
	public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
	{
		...
		$table = $setup->getConnection()
			->newTable($setup->getTable('atopt_office_department'))
			->addColumn(
				'entity_id', 
			...
			->setComment('Atopt Office Department Table');
		$setup->getConnection()->createTable($table);
		
		$employeeEntity = \Atopt\Office\Model\Employee::ENTITY;
		...
		$table = $setup->getConnection()
			...
			->setComment('Atopt Office Employee Table');
		$setup->getConnection()->createTable($table);
		...
		$table = $setup->getConnection()
			...
			->setComment('Atopt Office Employ Integer Attribute Backend Table');
		$setup->getConnection()->createTable($table);
		...
		$table = $setup->getConnection()
			...
			->addIndex(
				$setup->getIdxName(
						$employeeEntity . '_entity_datetime', ['attribute_id']),
						['attribute_id']
			)
			->addIndex(
			...
			->setComment('Atopt Office Employee Datetime Attribute Backend Table');
		$setup->getConnection()->createTable($table);
		...
		$table = $setup->getConnection()
			...
			->setComment('Atopt Office Employee Decimal Attribute Backend Table');
			...
			$table = $setup->getConnection()
				...
				->setComment('Atopt Office Employee Varchar Attribute Backend Table');
			...
			$table = $setup->getConnection()
				...
				->addIndex(
					$setup->getIdxName(
						$employeeEntity . '_entity_text', ['attribute_id']),
						['attribute_id']
					)
				->addIndex(
					$setup->getIdxName(
						$employeeEntity . '_entity_text', ['store_id']),
						['store_id']
					)
				->addForeignKey(
					$setup->getFkName(
				...
				->addForeignKey(
					...
					->setComment('Atopt Office Employee Text Attribute Backend Table');
